        ...
        <ul>
            ...
            <li>
                <?php 
                    ...
                    echo $this->Form->select('class-select', $classesNames, ['id' => "class-select", 'value' => $currentClassName]);
                ?>
            </li>
            ...
            <li>
                <?= $this->Form->checkbox("limittry", ['hiddenField' => false, "id" => "limittry", "value" => 1, 'checked' => !empty($chapter->tries)]); ?>
                ...
                <div id="limit-try-options">
                    ...
                    <?= $this->Form->number("try-number", ["id" => "try-number", "min" => "1", "max" => "100", "step" => "1", "value" => !empty($chapter->tries) ? $chapter->tries : 1]); ?>
                </div>
            </li>
