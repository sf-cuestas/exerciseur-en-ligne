...
let form = null;
let addTextBtn = null;
let addTitle1Btn = null;
let addTitle2Btn = null;
let addTitle3Btn = null;
let addTitle4Btn = null;
let addTitle5Btn = null;
let addTrueFalseBtn = null;
let addOpenQuestionBtn = null;
let addNumericalQuestionBtn = null;
let addMultipleChoiceBtn = null;
let addHintBtn = null;
let index = 0;
...
if (container!=null){ //Temporary solution to prevent console errors
    previewContainer = document.getElementById('previews');
    ...
    addTitle1Btn = document.getElementById('add-title-1');
    addTitle2Btn = document.getElementById('add-title-2');
    addTitle3Btn = document.getElementById('add-title-3');
    addTitle4Btn = document.getElementById('add-title-4');
    addTitle5Btn = document.getElementById('add-title-5');
    addTrueFalseBtn = document.getElementById('add-true-false');
    addOpenQuestionBtn = document.getElementById('add-open-question');
    addNumericalQuestionBtn = document.getElementById('add-numerical-question');
    addMultipleChoiceBtn = document.getElementById('add-multiple-choice');
    addHintBtn = document.getElementById('add-hint');
